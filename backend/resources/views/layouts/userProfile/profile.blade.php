                    ...
                    <div class="card-body">
                        <form action="{{ route('profile.updateFoto') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 text-center">
                                @if(Auth::user()->gambarUser)
                                    <img src="{{ asset('storage/profile/' . Auth::user()->gambarUser) }}" alt="User Photo"
                                        class="rounded-circle" style="width: 250px; height: 250px; object-fit: cover;">
                                @else
                                    <img src="{{ asset('images/default.jpg') }}" alt="Default Photo" class="rounded-circle"
                ...
                <div class="card shadow mb-3" style="height: 35dvh">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <div class="dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                ...
                                <a class="dropdown-item" href="{{route('profile.edit', Auth::user()->id)}}"><i class="fas fa-edit fa-sm fa-fw text-gray-400 mx-3"></i>Edit Profile</a>
                            </div>
                        </div>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        <h5 class="card-title text-primary mb-4">
                            <i class="fas fa-user-circle mx-2"></i>{{ Auth::user()->nama }}
                        </h5>
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                @if(Auth::user()->status ?? false)
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="badge bg-success text-dark">{{ Auth::user()->status }}</span>
                                    </li>
                                @endif
                            </ul>
                        @else
