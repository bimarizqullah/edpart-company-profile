...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="mb-4">
            <h4 class="text-primary">Katalog: {{ $katalog->namaKatalog }}</h4>
            <a href="{{ route('produk.index') }}" class="btn btn-secondary btn-icon-split">
                        ...
                        <tbody>
                            @forelse($produks as $produk)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge {{ $produk->statusProduk === 'aktif' ? 'badge-success' : 'badge-secondary' }}">
