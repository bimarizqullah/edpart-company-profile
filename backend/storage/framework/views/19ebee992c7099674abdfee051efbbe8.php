    ...
    <div class="col-md-12">
        ...
        <div class="card shadow mb-4 py-3">
            ...
            <div class="col-md-12 my-3 px-5">
                <form action="<?php echo e(route('katalog.update', $katalog->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control form-control-user" id="namaKatalog" name="namaKatalog"
                                value="<?php echo e($katalog->namaKatalog); ?>" required>
                            ...
                            <select name="kategori_id" id="kategori_id" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option 
                                        ...
                                        <?php echo e(old('kategori_id', $katalog->kategori_id) == $k->id ? 'selected' : ''); ?>

                                    >
                                        <?php echo e($k->namaKategori); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class=" col-md-12 form-group">
                            ...
                            <input type="textarea" class="form-control form-control-user" id="deskripsiKatalog"
                                name="deskripsiKatalog" value="<?php echo e($katalog->deskripsiKatalog); ?>" required>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="gambarKatalog" name="gambarKatalog"
                                    value="<?php echo e($katalog->gambarKatalog); ?>" accept="image/*">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('partials.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\edpArt\backend\resources\views/masterdata/katalog/edit.blade.php ENDPATH**/ ?>