<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="mb-4">
            <h4 class="text-primary">Katalog: <?php echo e($katalog->namaKatalog); ?></h4>
            <a href="<?php echo e(route('produk.index')); ?>" class="btn btn-secondary btn-icon-split">
                <span class="icon text-white-50">
                    <i class="fas fa-arrow-left"></i>
                </span>
                <span class="text">Choose Catalog</span>
            </a>
        </div>
        <div class="row mb-2">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $produks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge <?php echo e($produk->statusProduk === 'aktif' ? 'badge-success' : 'badge-secondary'); ?>">
