<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-3">EdpArt</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/katalog">
                    <i class="fas fa-box fa-sm fa-fw mr-2 text-gray-400"></i>
                    Catalog
                </a>
                <a class="collapse-item" href="/produk">
...
</ul><?php /**PATH D:\XAMPP\htdocs\edpArt\backend\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>